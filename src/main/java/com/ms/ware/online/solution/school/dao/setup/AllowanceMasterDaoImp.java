...
@Component
public class AllowanceMasterDaoImp implements AllowanceMasterDao {
    ...
    @Override
    public List<AllowanceMaster> getAll(String hql) {
        msg = "";
        Session session = HibernateUtilImpl.getSession();
        List<AllowanceMaster> list = new ArrayList<>();
    ...
    @Override
    public int save(AllowanceMaster obj) {
        Session session = HibernateUtilImpl.getSession();
        Transaction tr = session.beginTransaction();
        msg = "";
        row = 1;
    ...
    @Override
    public int update(AllowanceMaster obj) {
        Session session = HibernateUtilImpl.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
