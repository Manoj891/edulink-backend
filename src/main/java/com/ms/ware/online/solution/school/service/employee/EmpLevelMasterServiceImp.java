...
import com.ms.ware.online.solution.school.dao.employee.EmpLevelMasterDao;
...
@Service
public class EmpLevelMasterServiceImp implements EmpLevelMasterService {
    ...
    public ResponseEntity save(EmpLevelMaster obj) {
        ...
        try {
            try {
                sql = "SELECT ifnull(MAX(ID),0)+1 AS id FROM emp_level_master";
