...
public class SubjectGroupDetailDaoImp implements SubjectGroupDetailDao {
    ...
    @Override
    public List<SubjectGroupDetail> getAll(String hql) {
        msg = "";
        Session session = HibernateUtil.getSession();
        List<SubjectGroupDetail> list = new ArrayList<>();
    ...
    @Override
    public int save(SubjectGroupDetail obj) {
        Session session = HibernateUtil.getSession();
        Transaction tr = session.beginTransaction();
        msg = "";
        row = 1;
    ...
    @Override
    public int update(SubjectGroupDetail obj) {
        Session session = HibernateUtil.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
