...
public class BillingDeleteDetail implements Serializable {
    ...
    public BillingDeleteDetail(String billNo, int billSn, Long regNo, long academicYear, long program, long classId, long billId, double dr, double cr, String paymentDate, String isExtra) {
