...
@Component
public class PreAdmissionDaoImp implements PreAdmissionDao {
    ...
    @Override
    public List<PreAdmission> getAll(String hql) {
        msg = "";
        Session session = HibernateUtil.getSession();
        List<PreAdmission> list = new ArrayList<>();
    ...
    @Override
    public int save(PreAdmission obj) {
        Session session = HibernateUtil.getSession();
        Transaction tr = session.beginTransaction();
        msg = "";
        row = 1;
    ...
    @Override
    public int update(PreAdmission obj) {
        Session session = HibernateUtil.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
