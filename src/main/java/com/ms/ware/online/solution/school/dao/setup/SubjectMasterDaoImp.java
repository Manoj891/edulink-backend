...
@Component
public class SubjectMasterDaoImp implements SubjectMasterDao {
    ...
    @Override
    public List<SubjectMaster> getAll(String hql) {
        msg = "";
        Session session = HibernateUtil.getSession();
        List<SubjectMaster> list = new ArrayList<>();
    ...
    @Override
    public int save(SubjectMaster obj) {
        Session session = HibernateUtil.getSession();
        Transaction tr = session.beginTransaction();
        msg = "";
        row = 1;
    ...
    @Override
    public int update(SubjectMaster obj) {
        Session session = HibernateUtil.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
