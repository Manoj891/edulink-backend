...
@Component
public class ExamMasterDaoImp implements ExamMasterDao {
    ...
    @Override
    public List<ExamMaster> getAll(String hql) {
        msg = "";
        Session session = HibernateUtilImpl.getSession();
        List<ExamMaster> list = new ArrayList<>();
    ...
    @Override
    public int save(ExamMaster obj) {
        Session session = HibernateUtilImpl.getSession();
        Transaction tr = session.beginTransaction();
        msg = "";
        row = 1;
    ...
    @Override
    public int update(ExamMaster obj) {
        Session session = HibernateUtilImpl.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
