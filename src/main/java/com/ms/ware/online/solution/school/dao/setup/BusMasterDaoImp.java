...
@Component
public class BusMasterDaoImp implements BusMasterDao {
    ...
    @Override
    public List<BusMaster> getAll(String hql) {
        msg = "";
        Session session = HibernateUtilImpl.getSession();
        List<BusMaster> list = new ArrayList<>();
    ...
    @Override
    public int update(BusMaster obj) {
        Session session = HibernateUtilImpl.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
