...
@Component
public class EmployeeSalaryInfoDaoImp implements EmployeeSalaryInfoDao {
    ...
    @Override
    public List<EmployeeSalaryInfo> getAll(String hql) {
        msg = "";
    ...
    @Override
    public int save(EmployeeSalaryInfo obj) {
        Session session = util.getSession();
        Transaction tr = session.beginTransaction();
        msg = "";
        row = 1;
    ...
    @Override
    public int update(EmployeeSalaryInfo obj) {
        Session session = util.getSession();
        Transaction tr = session.beginTransaction();
        row = 1;
        msg = "";
